...
export default function Navbar() {
  ...
  return (
    <header
      className={`${scrolled ? "2xl-w-full fixed left-0 top-0 z-10 mx-0 w-full shadow-none xl:mx-[8em] xl:w-[74em] xl:shadow-lg 2xl:mx-0" : "shadow-none xl:mx-[8em] xl:shadow-lg"}`}
    >
