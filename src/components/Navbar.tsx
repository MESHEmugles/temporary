...
export default function Navbar() {
  ...
  return (
    <header
      className={`${scrolled ? "2xl:w-[90em] fixed left-0 top-0 z-[100] mx-0 w-full shadow-none xl:mx-[8em] xl:w-[74.035em] xl:shadow-lg 2xl:mx-[35em] 2xl:shadow-xl" : "shadow-none xl:mx-[8em] xl:shadow-lg 2xl:mx-[35em] 2xl:shadow-xl"}`}
    >
